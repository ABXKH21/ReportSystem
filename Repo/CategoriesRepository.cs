...
namespace ReportSystem.Repo
{
    public class CategoriesRepository : ICategoriesRepository
    {
        ...
        public CategoriesRepository(ReportSysContext reportSysContext)
        {
        ...
        public List<SubCategories> GetAllSubCategories(int mainCatId)
        {
            ...
            var selectedSub = subCategories.Where(w => w.MainCategoriesID == mainCatId).ToList();
            return selectedSub;
        }

        public List<ProcedureTypes> GetAllProceduerTypes(int subCatId)
        {
            ...
            var selectedprocedure = procedureTypes.Where(w => w.SubCategoriesID == subCatId).ToList();
            return selectedprocedure;
        }

        public ProcedureTypes GetProceduerTypeName(int id)
        {            
            var procedureTypes = reportSysContext.ProcedureTypes.FirstOrDefault(c => c.ProcedureTypeID == id);
